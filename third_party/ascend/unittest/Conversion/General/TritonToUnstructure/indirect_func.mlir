...
// CHECK:           %[[VAL_23:.*]] = ascend.unstructured_load %[[VAL_2:.*]] : <f32>, %[[VAL_22]] : tensor<8x16xi64> {{.*}}-> tensor<8x16xf32>
...
// CHECK:           ascend.unstructured_store %[[VAL_0:.*]] : <f32>, %[[VAL_29:.*]] : tensor<8x16xi64>, %[[VAL_24:.*]] : tensor<8x16xf32>
// CHECK:           tt.return
// CHECK:         }
