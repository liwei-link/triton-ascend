@triton.jit
def kernel(in0_ptr: tl.tensor,
           out0_ptr: tl.tensor,
           in0_stride0: int, in0_stride1: int, in0_stride2: int,
           in0_stride_order0: tl.constexpr, in0_stride_order1: tl.constexpr, in0_stride_order2: tl.constexpr,
           out0_stride0: int, out0_stride1: int, out0_stride2: int,
           out0_stride_order0: tl.constexpr, out0_stride_order1: tl.constexpr, out0_stride_order2: tl.constexpr,
